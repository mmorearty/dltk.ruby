...
public class RescueBodyNode extends Node {
	...
	public RescueBodyNode(ISourcePosition position, Node exceptionNodes,
			Node bodyNode, RescueBodyNode optRescueNode,
			ISourcePositionHolder rescueKeyword) {
